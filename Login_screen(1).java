...
public class Login_screen extends JFrame {
	...
	public Login_screen()
	{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				/*	Connection conn = DriverManager.getConnection("jdbc:postgresql://192.168.16.1:test","testty54045","modern");
					...
					*/
					...
					if(tf_username.getText().equals("omkar") && tf_pwd.getText().equals("omkar"))
		            {
		 				JOptionPane.showMessageDialog(null,"Login Successful.");
		 				dispose();
						new New_Dashboard();
		  		 	}
		            else if(tf_username.getText().equals("sameer") && tf_pwd.getText().equals("sameer"))
		            {
		 				 JOptionPane.showMessageDialog(null,"Login Successful.");
		 				dispose();
		 				new New_Dashboard();
		  		 	}
		  		 	// else if(tf_username.getText().equals("Prajyot") && tf_pwd.getText().equals("123"))
					// {
					// 	 JOptionPane.showMessageDialog(null,"Login Successful.");
					// 	 dispose();
					// 	 new New_Dashboard();
		...
		JButton btnAddRepresentative = new JButton("Add Representative");
